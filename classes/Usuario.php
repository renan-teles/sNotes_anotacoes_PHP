...
class Usuario extends Conexao {
    ...
    public function criarUsuario($nome, $email, $senha){
        try {
            ...
            $result->bindParam(':senha', $senhaHash);
            $result->execute();
    ...
    public function editarUsuario($id, $campo, $conteudo){
        ...
        try {
            if ($campo == 'senha') {
                $conteudo = password_hash($conteudo, PASSWORD_DEFAULT);
            }
    ...
    public function mostrarMensagem(){
        if (isset($_SESSION['msg'])) {
            echo '
            <div class="col-12">
                <div class="text-start alert alert-info alert-dismissible fade show" role="alert">
                    <i class="bi-info-circle me-1"></i>'.$_SESSION['msg'].' 
    ...
    public function preencherAtributosObjeto($id){
        try {
            ...
            echo 'Erro ao preencher atributos do usuário: ' . $e->getMessage();
        }
    }
}
?>
